package org.sopkathon.www.DoSoptSopkathon.card.controller.dto.response;
...
public record GetCardResponseDto(
    ...
    public static GetCardResponseDto of(User user, Card card) {
        return GetCardResponseDto.builder()
                .name(user.getName())
